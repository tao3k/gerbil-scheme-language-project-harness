...
(def +guide-basic-section+
  (make-guide-section
   ...
   "|cmd query-code=asp gerbil-scheme query --selector <gerbil-scheme://owner#item/kind/name> --workspace . --code"
...
(def +guide-exemplar-section+
  (make-guide-section
   "exemplars"
   ["|guideExemplar id=gerbil.higher-order-control.filter-map topic=higher-order-control intent=study rule=GERBIL-SCHEME-AGENT-POLICY-009 level=normal locator=parser-definition owner=src/checker/arity.ss symbols=call-arity-finding/known-signature,run-arity-checks comments=file-purpose+leading nextCommand=\"gerbil-scheme-harness guide --code --topic higher-order-control\" moreCommand=\"gerbil-scheme-harness guide --code --topic higher-order-control --more\" advancedCommand=\"gerbil-scheme-harness guide --code --topic higher-order-control --level advanced\""
   "|guideExemplar id=gerbil.functional-data-transform.filter-map topic=functional-data-transform intent=repair rule=GERBIL-SCHEME-AGENT-POLICY-009 level=normal locator=parser-definition owner=src/checker/arity.ss symbols=call-arity-finding/known-signature,run-arity-checks comments=file-purpose+leading nextCommand=\"gerbil-scheme-harness guide --code --rule GERBIL-SCHEME-AGENT-POLICY-009 --intent repair\""
   ...
   "|guideExemplar id=gerbil.poo-policy.prototype-fixed-point topic=poo-policy intent=repair rule=GERBIL-SCHEME-AGENT-POLICY-026 level=normal locator=runtime-source owner=gerbil-poo/t/object-test.ss symbols={(:: @ p) x:=>,x:=>.+,x:? fields=brace,super,slot-transform,default nextCommand=\"gerbil-scheme-harness guide --code --rule GERBIL-SCHEME-AGENT-POLICY-026 --intent repair\""
   "|guideExemplar id=gerbil.macro-runtime-source.witness topic=macro-runtime-source intent=witness rule=GERBIL-SCHEME-AGENT-POLICY-011 level=advanced locator=parser-definition owner=src/commands/search.ss symbols=matching-language-evidence-facts comments=file-purpose+leading nextCommand=\"gerbil-scheme-harness guide --code --topic macro-runtime-source --intent witness\""
