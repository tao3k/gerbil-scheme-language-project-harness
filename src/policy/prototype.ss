...
;; C3SlotProfile <- ProfileName (List SlotProfile) SlotPrototype MaybePrecedence
...
;; SlotPrototype <- (List SlotPrototype)
...
;; Value <- SlotPrototype Symbol Value
...
;; SlotPrototype <- SlotPrototype Symbol Value
...
;; SlotProfile <- String SlotPrototype supers: (List SlotProfile)
...
;; SlotProfile <- String (List SlotProfile)
...
;; Value <- SlotProfile Symbol Value
