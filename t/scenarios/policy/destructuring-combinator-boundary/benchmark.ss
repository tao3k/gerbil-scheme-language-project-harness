((maxTotalMs . 30)
 ...
 (targetRationale . "observed baseline 10-11ms for complex destructuring-combinator-boundary; target keeps native match repair visible and maxTotalMs is the hard regression ceiling")
 (maxCollectMs . 1000)
 (maxParseMs . 750)
 (maxFileMs . 250)
 (maxPhaseMs . 100)
