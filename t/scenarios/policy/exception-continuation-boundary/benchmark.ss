((maxTotalMs . 25)
 ...
 (targetRationale
  .
  "observed baseline 5ms for exception-continuation-boundary; target keeps the hot exception-policy scenario in the small millisecond budget while maxTotalMs remains the hard regression ceiling")
 (maxCollectMs . 10)
 (maxParseMs . 15)
 (maxFileMs . 5)
 (maxPhaseMs . 5)
