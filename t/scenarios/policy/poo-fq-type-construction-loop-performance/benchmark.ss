((maxTotalMs . 25)
 ...
 (observedTimings ((collect-before . 1)
                   ...
                   (policy-before . 0)
                   (policy-after . 0)))
 (targetRationale . "observed baseline 3ms for poo-fq-type-construction-loop-performance; target keeps optimization visible and maxTotalMs is the hard regression ceiling")
 (maxCollectMs . 1000)
 (maxParseMs . 750)
 (maxFileMs . 250)
 (maxPhaseMs . 100)
 ...
 (styleRewriteBoundary . "do not rebuild finite-field numeric type objects inside a measured loop; keep stable type objects hoisted")
