 ...
 (scenarios
  ((scenario
   ...
   (scenario
    ...
    (after (phase (targetFindings ())
                  (pooForms
                   ((pooForm (name "OrderFunctor.")
                             (role "type")
                             (supers ("Functor."))
                             (slots (".map" ".tap" ".ap"))
                             (options ("methodSlot:.map"
   ...
   (scenario
    ...
    (after (phase (targetFindings ())
                  (pooForms
                   ((pooForm (name "OrderPolynomial.")
                             (role "type")
                             (supers ("Polynomial."))
                             (slots (".Ring" ".zero" ".add" ".scale"))
                             (options ("methodSlot:.Ring"
