(guide (lines ("gerbil-scheme-harness guide"
               ...
               "|policy predicate-family-combinator=GERBIL-SCHEME-AGENT-R016 turns repeated field/role predicate families into policy-triggered helper or combinator repair using parser-owned predicateFamilyFacts"
               "|policy dependency-protocol-adapter=GERBIL-SCHEME-AGENT-R017 tells agents that dependency primitives already provide the bottom data structure: run guide --code for the R017 code shape, avoid loose hash/alist objects, build a thin define-type/protocol adapter with precise only-in imports, Key/Value/validate/serialization/equality slots, derived table/set/list/sexp/json/marshal capabilities, and generic t/ contract witnesses"
               "|policy explicit-precise-import=GERBIL-SCHEME-AGENT-R018"
